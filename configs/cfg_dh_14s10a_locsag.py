...
cfg.meta_df = f'{cfg.data_dir}/meta_v1.pkl'
...
# DATASET
cfg.dataset = "ds_dh_11n4" # "ds_ch_4"
cfg.classes = ['left_nfn', 'right_nfn', 'scs']
...
], additional_targets=dict((f'image{i}', 'image') for i in range(64)))
